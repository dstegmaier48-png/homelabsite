...
permalink: /digital/homelab/labsite/
---
...
![Context overview of the personal LabSite workflow from local Markdown authoring through GitHub Actions and Jekyll to GitHub Pages]({{ '/assets/images/digital/homelab/labsite/context-overview.png' | relative_url }})
